/*
* Memory bringup test: add, sw, lw with register forwarding.
...
// Usage: scripts/run.pl test_cpu_bringup_memory
...
module test_cpu_bringup_memory;
    ...
    class test_cpu_bringup_memory extends test_cpu_bringup_base;
        function new();
            super.new("test_cpu_bringup_memory");
        endfunction
    ...
    `define BRINGUP_TEST_CLASS test_cpu_bringup_memory
