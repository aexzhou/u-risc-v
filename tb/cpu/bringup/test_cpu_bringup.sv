...
module test_cpu_bringup;
    ...
    initial begin
        ...
        $display("  X1 = 0x%h", u_cpu.u_idu.u_regfile.X[1]);
        $display("  X2 = 0x%h", u_cpu.u_idu.u_regfile.X[2]);
        $display("  X3 = 0x%h", u_cpu.u_idu.u_regfile.X[3]);
        $display("  X4 = 0x%h", u_cpu.u_idu.u_regfile.X[4]);
        $display("  X5 = 0x%h", u_cpu.u_idu.u_regfile.X[5]);
        $display("  X6 = 0x%h", u_cpu.u_idu.u_regfile.X[6]);
        $display("");
